  ...
  export default {
    ...
    methods: {
       submit(){
        ...
        if(this.form.id){
           this.updateEpilesyData();
        }else {
          this.createEpilesyData();
        }
      ...
      updateEpilesyData(){
        var ID = this.form.id;
        var baseURL = this.$store.state.siteURL + 'api/cnse_pilesies/' + ID;
      ...
      getEpilesyData(){
        ...
        var patientID =  localStorage.getItem('patientID');
        var urlTohit = this.$store.state.siteURL + 'api/cnse_pilesies/' + patientID;
        axios
          .get(urlTohit)
          .then(r => {
            this.form = r.data.data;
